...
public class Constants {
	...
	public class Twitter {
		public static final String URL_TOKEN = "https://api.x.com/oauth2/token";
		public static final String URL_STREAM = "https://api.x.com/1.1/statuses/user_timeline.json?screen_name=";
		...
		public static final String URL_STREAM_MASTODONTE = "https://piaille.fr/api/v1/timelines/public";
	}
